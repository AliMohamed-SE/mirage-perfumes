    ...
    return (
      <Layout>
        <div className="container mx-auto px-4 py-32 text-center">
          ...
          <Button asChild className="bg-mirage-bronze hover:bg-mirage-bronze/90">
            ...
            <Tabs defaultValue="description">
              ...
              <TabsContent value="description" className="mt-6">
                <div className="max-w-3xl">
                  <h3 className="font-serif text-xl mb-4">About {product.name}</h3>
                  <p className="text-gray-600 mb-4">{product.description}</p>
                  <p className="text-gray-600">
                    Created by our master perfumer, this fragrance embodies the essence of modern masculinity. 
                    The carefully selected notes work in harmony to create a unique scent that is both sophisticated and captivating.
                  </p>
                </div>
              </TabsContent>
                ...
                <div className="max-w-3xl space-y-4">
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-600">
                      ...
                      <li><span className="font-medium">Category:</span> {product.category.charAt(0).toUpperCase() + product.category.slice(1)} Collection</li>
                      <li><span className="font-medium">Made in:</span> France</li>
                      <li><span className="font-medium">Concentration:</span> Eau de Parfum</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Alcohol Denat., Parfum (Fragrance), Aqua (Water), Limonene, Linalool, Coumarin, Citral, Geraniol, Citronellol, Eugenol.
                    </p>
                  </div>
                </div>
              </TabsContent>
              <TabsContent value="reviews" className="mt-6">
                <div className="max-w-3xl">
                  ...
                  <p className="text-gray-600 mb-8">
                    This product has not been reviewed yet. Be the first to share your experience.
                  </p>
