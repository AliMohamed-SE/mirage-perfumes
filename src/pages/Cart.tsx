      ...
      <div className="container mx-auto px-4 py-32">
        ...
        {cartDetails.length === 0 ? (
          <div className="text-gray-600">
            ...
            <Button asChild className="mt-6 bg-mirage-bronze hover:bg-mirage-bronze/90">
          ...
          <div className="w-full max-w-2xl mx-auto bg-white rounded-lg shadow p-6">
            <ul>
              {cartDetails.map(item => (
                ...
                >
                  <img src={item!.image} alt={item!.name} className="h-16 w-16 object-cover rounded mr-4 border" />
                  ...
                  <div className="text-right flex flex-col items-end">
                    <div className="text-mirage-bronze font-bold">${item!.subtotal.toFixed(2)}</div>
                    <Button
                      variant="outline"
                      size="sm"
            ...
            <div className="flex justify-between mt-6 text-xl">
              <span>Total</span>
              <span className="font-bold text-mirage-bronze">${total.toFixed(2)}</span>
            </div>
            <Button 
