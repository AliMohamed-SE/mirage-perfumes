...
const PrivacyPolicy = () => (
  <Layout>
    <div className="container mx-auto max-w-3xl px-4 py-16 min-h-[60vh]">
      ...
      <p className="mb-6">
        Mirage values your privacy. This Privacy Policy describes how we collect, use, and safeguard your information when you use our website.
      </p>
      ...
      <p>
        If you have any questions or concerns regarding this Privacy Policy, please contact us via the <a href="/contact" className="underline hover:text-mirage-bronze">Contact</a> page.
      </p>
    </div>
  </Layout>
);
