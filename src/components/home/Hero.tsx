...
const Hero = () => {
  return (
    <section className="relative h-screen flex items-center bg-mirage-charcoal">
      {/* Background Image */}
      ...
      <div className="container mx-auto px-4 md:px-6 z-10 text-white">
        <div className="max-w-3xl">
          ...
          <p
            className="mt-6 text-lg md:text-xl text-gray-200 max-w-2xl animate-fade-in"
          ...
          >
            <Button
              asChild
              className="bg-mirage-bronze hover:bg-mirage-bronze/90 text-white border-none px-8 py-6"
            >
            ...
            <Button
              asChild
              variant="outline"
              className="bg-transparent text-white border-white hover:bg-white/10 px-8 py-6"
            >
